---
name: clone-fidelity-reviewer
description: Read-only clone and design-system fidelity reviewer. Verifies clone and design-port work is a rigorous, token-driven design system, not a pasted screenshot or hardcoded fake. Use when verifying UI clone fidelity against a reference design.
